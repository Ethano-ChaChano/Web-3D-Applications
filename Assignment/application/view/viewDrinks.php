...
<body>
    <h1 style='margin:5px; padding:10px; color:#204795; font-size: 80px;'>Choose a drink brand to see more details</h1>
    <b style='margin:5px; padding:10px; color:#E7223A; font-size: 40px;'>Select a drinks brand name: </b>
                ...
                $.getJSON(brandUrl, function(json) {
                  ...
                  for (var i=0; i<json.length; i++) {
                      ...
                      str +=
                        ...
                        "<img width='300px' src = '../assets/images/render_images/" + json[i].brand + "Render.jpg'></img>" +
                        "</div>";
                  }
